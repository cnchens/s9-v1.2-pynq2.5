...
//Date        : Sun Nov  3 11:50:12 2024
//Host        : chnw-removable running 64-bit Ubuntu 18.04.6 LTS
//Command     : generate_target s9_pynq.bd
//Design      : s9_pynq
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "s9_pynq,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=s9_pynq,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "s9_pynq.hwdef" *) 
module s9_pynq
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  s9_pynq_processing_system7_0_0 processing_system7_0
