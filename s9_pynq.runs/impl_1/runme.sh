...
HD_PWD='/mnt/sda5/s9_pynq/s9_pynq.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log s9_pynq_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source s9_pynq_wrapper.tcl -notrace
