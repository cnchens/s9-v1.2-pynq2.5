...
HD_PWD='/mnt/sda5/s9_pynq/s9_pynq.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log s9_pynq_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source s9_pynq_wrapper.tcl
