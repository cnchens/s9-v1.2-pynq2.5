...
HD_PWD='/mnt/sda5/s9_pynq/s9_pynq.runs/s9_pynq_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log s9_pynq_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source s9_pynq_processing_system7_0_0.tcl
